...
#
# Script generated by Vivado on Wed Jul 31 16:43:23 +0200 2024
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../ipstatic" +incdir+"F:/programy/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../ipstatic" +incdir+"F:/programy/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../ipstatic" +incdir+"F:/programy/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
