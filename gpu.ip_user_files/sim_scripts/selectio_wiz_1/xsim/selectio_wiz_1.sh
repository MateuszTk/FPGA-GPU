...
#
# Script generated by Vivado on Tue Jul 23 18:58:19 +0200 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : selectio_wiz_1.sh
...
#
# Usage        : selectio_wiz_1.sh
#                selectio_wiz_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                selectio_wiz_1.sh [-reset_run]
#                selectio_wiz_1.sh [-reset_log]
#                selectio_wiz_1.sh [-help]
#
...
# script info
echo -e "selectio_wiz_1.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./selectio_wiz_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot selectio_wiz_1 xil_defaultlib.selectio_wiz_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim selectio_wiz_1 -key {Behavioral:sim_1:Functional:selectio_wiz_1} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="F:/programy/Xilinx/Vivado/2024.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb selectio_wiz_1.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./selectio_wiz_1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: selectio_wiz_1.sh [-help]\n\
Usage: selectio_wiz_1.sh [-step]\n\
Usage: selectio_wiz_1.sh [-lib_map_path]\n\
Usage: selectio_wiz_1.sh [-reset_run]\n\
Usage: selectio_wiz_1.sh [-reset_log]\n\
Usage: selectio_wiz_1.sh [-keep_index]\n\
Usage: selectio_wiz_1.sh [-noclean_files]\n\n\
